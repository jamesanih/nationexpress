...
<html lang="en">
	...
	<head>
		...
		<title>Place Order - PickUp Details - NationExpress24 Delivery</title>
				...
				<div class="row">
					<div class="col-md-5 col-sm-6">
						<div class="calculate_title">
							...
							<? } ?>
							<p><font color="#000"><b>Pickup Information</b></font></p>
						</div>
			<? if($mycolor !="green"){ ?>	
						<div class="calculate_form">
							<form role="form" id="pickup-form" name="pickup-form" method="post" action="" class="pickup-form" autocomplete="OFF">
