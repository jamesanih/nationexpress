...
//Let's get the pickup price for within Lagos
		...
		if($userid){
			...
			$sqln = "INSERT INTO `delivery_details` (`account_id`, `booking_no`, `address`, `city`, `state`, `country`, `date`, `time`) VALUES ('".$userid."', '".$booking_no."', '".$delivery_address."', '".$delivery_city."', '".$delivery_state."', '".$delivery_country."', '".$date."', '".$time."')";
				$rsN = mysql_query($sqln) or die("Errorn : ".mysql_error());
				
				$sqln = "INSERT INTO `pickup_details` (`account_id`, `booking_no`, `address`, `city`, `state`, `date`, `time`) VALUES ('".$userid."', '".$booking_no."', '".$pickup_address."', '".$pickup_city."', '".$pickup_state."', '".$date."', '".$time."')";
				$rsN = mysql_query($sqln) or die("Errorn : ".mysql_error());
				
				$sqln = "INSERT INTO `parcel_details` (`account_id`, `booking_no`, `weight_kg`, `date`, `time`) VALUES ('".$userid."', '".$booking_no."', '".$weight_kg."', '".$date."', '".$time."')";
				$rsN = mysql_query($sqln) or die("Errorn : ".mysql_error());
			...
			$sqln = "INSERT INTO `delivery_details` (`booking_no`, `address`, `city`, `state`, `country`, `date`, `time`) VALUES ('".$booking_no."', '".$delivery_address."', '".$delivery_city."', '".$delivery_state."', '".$delivery_country."', '".$date."', '".$time."')";
				$rsN = mysql_query($sqln) or die("Errorn : ".mysql_error());
				
				$sqln = "INSERT INTO `pickup_details` (`booking_no`, `address`, `city`, `state`, `date`, `time`) VALUES ('".$booking_no."', '".$pickup_address."', '".$pickup_city."', '".$pickup_state."', '".$date."', '".$time."')";
				$rsN = mysql_query($sqln) or die("Errorn : ".mysql_error());
				
				$sqln = "INSERT INTO `parcel_details` (`booking_no`, `weight_kg`, `date`, `time`) VALUES ('".$booking_no."', '".$weight_kg."', '".$date."', '".$time."')";
				$rsN = mysql_query($sqln) or die("Errorn : ".mysql_error());
