													...
													<? do {?>
														...
														<?php if($myaccount_id){ ?>
															<tr>
																...
																<td><? if($mystatus == "Order Booked"){ ?><a href="edit_order?booking_no=<? echo $b_booking_no; ?>" target="_blank"><button class="btn btn-default" title="Click here to edit the order">Edit Order</button></a><? }else{?> N/A <?}?></td>
															</tr>
														<? } ?>
