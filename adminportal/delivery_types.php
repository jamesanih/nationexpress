<?php
	include("check.php");
	include("delivery_type_check.php");
?>
<!DOCTYPE html>
<html lang="en">
	...
	<head>
		...
		<title>Delivery Types - NationExpress24 Delivery</title>
						...
						<div class="pricing-desc section-padding-two">
							<div class="pricing-desc-title">
								<div class="title">
									...
									<p>Here is where you will manage the delivery types</p>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4 col-lg-12 col-sm-4 col-xs-12 text-center">
						<div class="panel-body">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#recent" data-toggle="tab">Delivery Types</a>
								</li>
											...
											<tbody>
												<? do {?>
													<?
														...
														$type_del_st = $val_b_type['delivery_st'];
														$type_coll_et = $val_b_type['collection_et'];
														$type_del_et = $val_b_type['delivery_et'];
														$type_status = $val_b_type['status'];
														$type_id = $val_b_type['type_id'];
													?>
													...
													<? } ?>
												<? }while($val_b_type = mysqli_fetch_array($sql_b_type)) ?>
