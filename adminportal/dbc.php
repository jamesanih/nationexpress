...
function GenRegAcctID() {
		...
		$sql_account = mysqli_query($connect, "SELECT `account_id` FROM `register` WHERE `account_id`='$account_id' ORDER BY ID DESC LIMIT 1");
...
function GenSellOrderID() {
	...
	//Generate Login ID
function GenloginID() {
		$sql_login = mysqli_query($connect, "SELECT * FROM `dbx-login-details` WHERE `login_id`!='' ORDER BY ID DESC LIMIT 1");
...
function GeniloginID() {
		$sql_ilogin = mysqli_query($connect, "SELECT * FROM `dbx-invalid-login` WHERE `login_id`!='' ORDER BY ID DESC LIMIT 1");
...
function GenToken() {
		...
		$sql_tokenid = mysqli_query("SELECT `tokenid` FROM `dbx-register` WHERE `tokenid`='$tokenid' ORDER BY ID DESC");
...
function GenQuestionID() {
		...
		$sql_question = mysqli_query("SELECT * FROM `dbx-questions` WHERE `question_id`='$question_id' ORDER BY ID DESC LIMIT 1");
