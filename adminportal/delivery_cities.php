<?php
	include("check.php");
	include("delivery_cities_check.php");
?>
<!DOCTYPE html>
<html lang="en">
	...
	<head>
		...
		<title>Delivery Cities - NationExpress24 Delivery</title>
						...
						<div class="pricing-desc section-padding-two">
							<div class="pricing-desc-title">
								<div class="title">
									...
									<p>Here is where you will manage the delivery cities</p>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4 col-lg-12 col-sm-4 col-xs-12 text-center">
						<div class="panel-body">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#recent" data-toggle="tab">Delivery Cities</a>
								</li>
											...
											<tbody>
												<? do {?>
													<?
														...
														$delivery_id = $val_b_type['delivery_id'];
														$unit_price = $val_b_type['unit_price'];
														$add_kg_cost = $val_b_type['add_kg_cost'];
