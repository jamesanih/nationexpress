					...
					<div class="col-md-5 col-sm-6">
						...
						<div class="calculate_form">
							<form role="form" id="pricing-form" name="pricing-form" method="post" action="" class="pricing-form" autocomplete="OFF">
								...
								<div class="totla-cost" id="price_slate" style="display:none">
									<h5>Pickup Cost: <span id="pickup_price">$ 30</span></h5>
									<h5>Delivery Cost: <span id="delivery_price">$ 30</span></h5>
